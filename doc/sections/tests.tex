...
\begin{document}
    ...
    Dans les fichiers .s, sont fournis des commentaires décrivant l'état (des registres et des drapeaux) obtenu en cas de succès.
    Les fichiers .bin sont à charger dans la ROM. \\
