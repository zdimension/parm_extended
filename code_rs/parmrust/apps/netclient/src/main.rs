...
use parm::embedded_graphics::mono_font::ascii::FONT_6X13_BOLD;
...
use parm::screen::{Color, ColorSimple, ParmScreen, rgb32};
use parm::tty::{ParmLogger, read_line_rust};
use parm::{print, rprintln};
use sha2::digest;
use simple_dns::rdata::RData;
use simple_dns::{CLASS, Name, Packet, PacketFlag, Question, TYPE};
use simple_dns::CLASS::NONE;
use speedy::{Context, Readable, Writable, Writer};
use speedy_telnet::SpeedyTelnet;
use typenum::{Sum, U10, U12, U32};
use crate::web::{render, Element};
