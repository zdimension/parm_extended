...
use parm::{keyb, print, println, rprint, rprintln, telnet, tty};
use parm::control::breakpoint;
use crate::arm::Reg::R0;
use crate::arm::RegList;
use crate::compiler::{Analysis2, Compiler};
use crate::parse::{CParser, ParseError, PositionedError};
use crate::scope::Scope;
use crate::types::{QualType, Signedness, TypeQualifiers, UnqualType};
    ...
    $(
        ...
        fn add_exposed_functions(scope: &mut Scope) {
            ...
            $({
                ...
                let mut jcomp = crate::emitter::Emitter::default();
                ...
                scope.symbols.insert(
                    ...
                    SymbolKind::Function {
                        proto: FunctionImpl {
                            ...
                            args: parm::OrderedMap::from_iter([ $(
            ...
            $({
                ...
                scope.symbols.insert(
                    ...
                    SymbolKind::Variable {
                        ...
                        pos: VarPosition::Global(unsafe { aligned_vec::ABox::from_raw_parts(4, core::ptr::slice_from_raw_parts_mut(
                            $s_val as *mut u8,
                            s_size,
                        )) }),
                    },
