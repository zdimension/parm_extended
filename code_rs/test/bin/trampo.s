...
.LBB100_3:
add	r0, sp, #36
ldr r1, trampo_wco5j_addr
b trampo_wco5j_after
.p2align 2
trampo_wco5j_addr: .long .LCPI100_33
trampo_wco5j_after: ldr r1, [r1]
bl	_ZN4core3cmp5impls69_$LT$impl$u20$core..cmp..PartialEq$LT$$RF$B$GT$$u20$for$u20$$RF$A$GT$2eq17h27a051c63443aa73E
cmp	r0, #0
beq	.LBB100_6
add	r0, sp, #52
ldr r2, trampo_5vy6x_addr
b trampo_5vy6x_after
.p2align 2
trampo_5vy6x_addr: .long .LCPI100_34
trampo_5vy6x_after: ldr r2, [r2]
movs	r3, #10
mov	r1, r6
bl	_ZN4lisp4lisp3val8LispList8params_n17hf863fdd00c38d305E
ldr	r0, [sp, #52]
...
.LBB111_13:
movs	r0, #0
ldr r3, trampo_6o08h_addr
b trampo_6o08h_after
.p2align 2
trampo_6o08h_addr: .long .LCPI111_2
trampo_6o08h_after: ldr r3, [r3]
.LBB111_14:
cmp	r0, #7
beq	.LBB111_17
ldrb	r1, [r3, r0]
...
b	.LBB121_94
.LBB121_45:
ldr r2, trampo_4ae90_addr
b trampo_4ae90_after
.p2align 2
trampo_4ae90_addr: .long .LCPI121_1
trampo_4ae90_after: ldr r2, [r2]
movs	r3, #7
.LBB121_46:
mov	r0, r5
mov	r1, r4
