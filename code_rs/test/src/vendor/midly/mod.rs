...
mod prelude {
    #[cfg(feature = "std")]
    pub(crate) use crate::vendor::midly::io::IoWrap;
    pub(crate) use crate::vendor::midly::{
...
#[cfg(feature = "std")]
pub use crate::vendor::midly::smf::write_std;
#[cfg(feature = "alloc")]
pub use crate::vendor::midly::{
    arena::Arena,
...
pub mod num {
    pub use crate::vendor::midly::primitive::{u14, u15, u24, u28, u4, u7};
}
